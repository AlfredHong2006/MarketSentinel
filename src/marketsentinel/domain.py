...
class AutomaticAnalysisDiagnostics(BaseModel):
    ...
    official_family_cap_rejected: int = Field(default=0, ge=0)
    near_title_rejected: int = Field(default=0, ge=0)
    market_reaction_rejected: int = Field(default=0, ge=0)
    scheduled_insider_sale_rejected: int = Field(default=0, ge=0)
